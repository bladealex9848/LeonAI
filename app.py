...
APP_IDENTITY = {
    ...
    "version": "1.0.0",
    "icon": "🦁",
    "tagline": "Tu asistente virtual para la Institución Educativa Bosques de León",
    "full_title": "Bienvenid@s 🦁",
    
    # Información del desarrollador
    "developer": "Alexander Oviedo Fadul",
    "github_url": "https://github.com/bladealex9848",
    "website_url": "https://alexanderoviedofadul.dev/",
    "docs_url": "https://github.com/bladealex9848/LeonAI/blob/main/README.md",
    ...
    "repository_url": "https://github.com/bladealex9848/LeonAI",
    
    # Descripción de la aplicación - formas corta y larga
    "short_description": "Tu asistente virtual para la Institución Educativa Bosques de León.",
    "long_description": """
    ...
    * Contarte sobre la filosofía, misión, visión y políticas de la institución
    * Describir los procesos de admisión, matrícula, evaluación y promoción de estudiantes
    * Explicarte las normas de convivencia, los derechos y deberes de los estudiantes, y el uso de uniformes
    * Responder preguntas sobre eventos institucionales, como la ceremonia de graduación y la primera comunión
    * Guiarte en el acceso y uso de la plataforma virtual Cisco Webex
    * Aclarar dudas sobre los costos educativos, el proceso de inscripción y otros temas administrativos

    **¡No dudes en consultarme cualquier inquietud sobre la Institución Educativa Bosques de León!**

    *Recuerda: Proporciono información general basada en la documentación disponible. Para información oficial o trámites específicos, contacta directamente con la institución.*
    """,
    
    # User instructions
    "usage_instructions": """
    1. **Consultas generales**: Escribe tu pregunta en el chat para recibir información sobre la Institución Educativa Bosques de León.

    2. **Temas específicos**: Puedes preguntar sobre la filosofía institucional, procesos académicos, normas de convivencia y más.

    3. **Eventos y actividades**: Consulta información sobre ceremonias, actividades extracurriculares y eventos importantes.

    4. **Plataforma virtual**: Obtén ayuda para acceder y utilizar la plataforma Cisco Webex para clases virtuales.

    5. **Procesos administrativos**: Solicita información sobre costos, inscripciones, matrículas y otros trámites.
    """,
    
    # Document processing information
    "document_processing_info": """
    Esta aplicación utiliza tecnología avanzada para:

    - Extraer información relevante de documentos institucionales
    - Analizar preguntas y proporcionar respuestas precisas sobre la institución
    - Identificar información clave sobre los procesos académicos y administrativos
    - Facilitar la comprensión de la documentación institucional
    ...
    **Nota sobre privacidad**: Los documentos se procesan localmente y no se almacenan permanentemente.
    ...
    "file_upload_default_message": "He cargado el documento '{files}' para análisis. Por favor, indícame qué información necesitas extraer de este documento relacionada con la Institución Educativa Bosques de León.",
    "badges": """
    ...
    Soy tu asistente virtual para la Institución Educativa Bosques de León. Estoy aquí para ayudarte a obtener información sobre la institución.

    * Puedo responder preguntas sobre la filosofía institucional
    * Brindarte información sobre procesos académicos y administrativos
    * Explicarte las normas de convivencia y el manual del estudiante
    * Informarte sobre eventos y actividades institucionales
    * Ayudarte con el acceso a la plataforma virtual
    ...
    **¿En qué puedo ayudarte hoy?**
    ...
    "document_prefix": "leonai",
    "conversation_export_name": "leonai_conversacion",
}
